...
public class CaesarCipherTests {
  ...
  @Test public void test_Caesar_1(){ assertEquals(5,new CaesarCipher(5).shift); }
  @Test public void test_Caesar_2(){ assertEquals(50,new CaesarCipher(50).shift); }
  @Test public void test_Caesar_3(){ assertEquals(-8,new CaesarCipher(-8).shift); }
  @Test public void test_Caesar_4(){ assertEquals(Alphabet.DEFAULT,new CaesarCipher(20).getAlphabet()); }
  
  @Test public void test_Caesar_5(){
    Alphabet a =  new Alphabet("ABCDEFGHIJKLMNOP");
    CaesarCipher c = new CaesarCipher(10,a);
    assertEquals(a, c.alphabet);
  }
  
  @Test public void test_Caesar_6(){ assertEquals('X',new CaesarCipher(  0) .encrypt1('X')); }
  @Test public void test_Caesar_7(){ assertEquals('Y',new CaesarCipher(  1) .encrypt1('X')); }
  @Test public void test_Caesar_8(){ assertEquals('1',new CaesarCipher(  2) .encrypt1('z')); }
  @Test public void test_Caesar_9(){ assertEquals('e',new CaesarCipher(100) .encrypt1('X')); }
  @Test public void test_Caesar_10(){ assertEquals('S',new CaesarCipher( -5) .encrypt1('X')); }
  @Test public void test_Caesar_11(){ assertEquals(',',new CaesarCipher(-10) .encrypt1('E')); }
  
  @Test public void test_Caesar_12(){ assertEquals('X',new CaesarCipher(  0) .decrypt1('X')); }
  @Test public void test_Caesar_13(){ assertEquals('W',new CaesarCipher(  1) .decrypt1('X')); }
  @Test public void test_Caesar_14(){ assertEquals('x',new CaesarCipher(  2) .decrypt1('z')); }
  @Test public void test_Caesar_15(){ assertEquals('Q',new CaesarCipher(100) .decrypt1('X')); }
  @Test public void test_Caesar_16(){ assertEquals('c',new CaesarCipher( -5) .decrypt1('X')); }
  @Test public void test_Caesar_17(){ assertEquals('P',new CaesarCipher(-11) .decrypt1('E')); }
  
  
  @Test public void test_Caesar_18(){ assertEquals("catfood for cats",new CaesarCipher(0, lowerSpace).encrypt("catfood for cats")); }
  @Test public void test_Caesar_19(){ assertEquals("catfood for cats",new CaesarCipher(0, lowerSpace).decrypt("catfood for cats")); }
  @Test public void test_Caesar_20(){ assertEquals("trjweeu",new CaesarCipher(17, lowerSpace).encrypt("catfood")); }
  @Test public void test_Caesar_21(){ assertEquals("catfood",new CaesarCipher(17, lowerSpace).decrypt("trjweeu")); }
  @Test public void test_Caesar_22(){ assertEquals("bjvxwyfrwmzn",new CaesarCipher(-5, lowerSpace).encrypt("go backwards")); }
  @Test public void test_Caesar_23(){ assertEquals("go backwards",new CaesarCipher(-5, lowerSpace).decrypt("bjvxwyfrwmzn")); }
  @Test public void test_Caesar_24(){
  ...
  @Test public void test_Caesar_25(){
  ...
  @Test public void test_Caesar_26(){
    CaesarCipher c = new CaesarCipher(300, lowerSpace);
    String clear   = "long messages are no extra hassle";
    String crypted = "orqjcphvvdjhvcduhcqrch wudckdvvoh";
    assertEquals(clear,c.decrypt(crypted));
  }
  @Test public void test_Caesar_27(){
  ...
  @Test public void test_Caesar_28(){ assertEquals("NYLLUFZSPTLFPZFKLHKSDG",new CaesarCipher(7,uppers).encrypt("GREEN SLIME IS DEADLY.")); }
  @Test public void test_Caesar_29(){ assertEquals("SBQQZKCXUYQKUCKO YUZS",new CaesarCipher(40,uppers).encrypt("GREEN SLIME IS COMING")); }
  @Test public void test_Caesar_30(){ assertEquals("GMXXCKUZKDTQKGMI",new CaesarCipher(40,uppers).encrypt("WALLS IN THE WAY")); }
  @Test public void test_Caesar_31(){ assertEquals("WALLS IN THE WAY",new CaesarCipher(40,uppers).decrypt("GMXXCKUZKDTQKGMI")); }
  
  
  @Test public void test_Caesar_32(){
    try {
  ...
  @Test public void test_Caesar_33(){
    try {
  ...
  @Test public void test_Caesar_34(){
    try {
      String s = new CaesarCipher(12,lowers).encrypt("HELLO");
    } catch (MissingCharAlphabetException e){ return; }
    fail("shouldn't encrypt any characters not in the alphabet.");
  }
  @Test public void test_Caesar_35(){
    try {
  ...
  @Test public void test_Caesar_36(){
