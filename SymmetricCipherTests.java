...
public class SymmetricCipherTests {
  ...
  @Test public void test_Symmetric_1(){ assertEquals( 5, swap.rotate( 4,  1)); }
  @Test public void test_Symmetric_2(){ assertEquals( 5, swap.rotate( 4,  1)); }
  @Test public void test_Symmetric_3(){ assertEquals( 3, swap.rotate( 4, -1)); }
  @Test public void test_Symmetric_4(){ assertEquals(10, swap.rotate(10, 93)); } // DEFAULT has 93 characters.
  @Test public void test_Symmetric_5(){ assertEquals(91, swap.rotate( 3, -5)); }
  @Test public void test_Symmetric_6(){ assertEquals( 9, swap.rotate( 2,100)); }
  //"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz 1234567890!@#$%^&*()_+-=[]{}\\|;:'\",./?<>"
  @Test public void test_Symmetric_7(){ assertEquals( Alphabet.DEFAULT, swap.getAlphabet()); }
  @Test public void test_Symmetric_8(){ assertEquals( uppers, new SwapRWCipher(uppers).getAlphabet()); }
  
  @Test public void test_Symmetric_9() { assertEquals( 1, swap.wrapInt(   1)); }
  @Test public void test_Symmetric_10(){ assertEquals( 0, swap.wrapInt(  93)); }
  @Test public void test_Symmetric_11(){ assertEquals(92, swap.wrapInt(  -1)); }
  @Test public void test_Symmetric_12(){ assertEquals(88, swap.wrapInt(  -5)); }
  @Test public void test_Symmetric_13(){ assertEquals(70, swap.wrapInt(1000)); }
  
  @Test public void test_Symmetric_14(){ assertEquals("no fancy alphas", swap.encrypt("no fancy alphas"));}
  @Test public void test_Symmetric_15(){ assertEquals("no fancy alphas", swap.decrypt("no fancy alphas"));}
  @Test public void test_Symmetric_16(){ assertEquals("hello rowld", swap.encrypt("hello world"));}
  @Test public void test_Symmetric_17(){ assertEquals("rwRW", swap.encrypt("wrWR"));}
  @Test public void test_Symmetric_18(){ assertEquals("hello rowld", swap.decrypt("hello world"));}
  @Test public void test_Symmetric_19(){ assertEquals("rwRW", swap.decrypt("wrWR"));}
